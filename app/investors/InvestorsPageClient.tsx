...
export default function InvestorsPageClient() {
  ...
  const addToCalendar = (event: {
    ...
    const googleCalendarUrl = `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent(event.title)}&dates=${startDate
      .toISOString()
      .replace(/[-:]/g, "")
      .replace(/\.\d{3}/, "")}\/${endDate
      .toISOString()
      ...
      .replace(
        /\.\d{3}/,
        ""
      )}&details=${encodeURIComponent(`Location: ${event.location}`)}&location=${encodeURIComponent(event.location)}`;
                  ...
                  <div className="inline-block mb-4">
                    <div className="inline-flex items-center rounded-full border border-primary/30 bg-primary/10 px-4 py-1 text-sm">
                      <span className="text-primary font-medium">
                        {data.financialHighlights.tagline}
                      </span>
                    </div>
                  </div>
                  <h2 className="text-3xl md:text-4xl font-bold mb-6">
                    {data.financialHighlights.title}
                  </h2>
                    ...
                    >
                      ...
                      >
                        <motion.div
                          ...
                          initial={{ width: 0 }}
                          whileInView={{
                            width: `${metric.progressPercentage}%`,
                          }}
                          viewport={{ once: true }}
              ...
              <FadeIn direction="up">
                <div className="text-center max-w-3xl mx-auto mb-16">
                  <div className="inline-block mb-4">
                    <div className="inline-flex items-center rounded-full border border-primary/30 bg-primary/10 px-4 py-1 text-sm">
                      <span className="text-primary font-medium">
                        {data.financialReports.tagline}
                      </span>
                    </div>
                  </div>
                  <h2 className="text-3xl md:text-4xl font-bold mb-6">
                    {data.financialReports.title}
                  </h2>
                  <p className="text-muted-foreground text-lg">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative bg-card/50 backdrop-blur-sm border border-border rounded-xl overflow-hidden">
                      <div className="aspect-video w-full relative">
                        <Image
                          src={
                            data.upcomingEvents.presentation.thumbnailImage.url
                          }
                          alt={data.upcomingEvents.presentation.title}
                          width={
                            data.upcomingEvents.presentation.thumbnailImage
                      ...
                      <div className="p-6">
                        <h3 className="text-xl font-bold mb-2">
                          {data.upcomingEvents.presentation.title}
                        </h3>
              ...
              <FadeIn direction="up">
                <div className="text-center max-w-3xl mx-auto mb-16">
                  <div className="inline-block mb-4">
                    <div className="inline-flex items-center rounded-full border border-primary/30 bg-primary/10 px-4 py-1 text-sm">
                      <span className="text-primary font-medium">
                        {data.boardOfDirectors.tagline}
                      </span>
                    </div>
                  </div>
                  <h2 className="text-3xl md:text-4xl font-bold mb-6">
                    {data.boardOfDirectors.title}
                  </h2>
                  <p className="text-muted-foreground text-lg">
                    ...
                    <div className="flex flex-col space-y-4">
                      ...
                      >
                        <Button
                          ...
                          className="border-primary text-primary hover:bg-primary hover:text-white w-full"
                          onClick={() =>
                            (window.location.href = `mailto:${data.contactIR.email}`)
                          }
                        >
                          Email IR Team
                        </Button>
