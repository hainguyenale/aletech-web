...
export default function AnimatedSolution({ data, footerData }: AnimatedSolutionProps) {
          ...
          >
            <motion.div variants={itemVariants} className="space-y-6">
              ...
              <p className="text-muted-foreground">
                Our {data.label} solutions come with a comprehensive set of features designed to address your specific needs.
              </p>
              ...
              <div className="relative bg-card/50 backdrop-blur-sm border border-border rounded-xl overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 p-4 sm:p-6">
                  <div className="inline-flex items-center rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs">
                    <span className="text-primary font-medium">{data.label} Solutions</span>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-3">Benefits of Our {data.label} Solutions</h2>
            <div className="h-1 w-16 bg-primary mx-auto mb-4"></div>
            <p className="text-muted-foreground">
              Discover how our {data.label} solutions can transform your business operations and drive growth.
            </p>
          </div>
            ...
            {data.benefits.map((benefit, index) => (
              ...
              >
                ...
                <div className="relative bg-card rounded-lg p-6">
                  ...
                  <p className="text-muted-foreground">
                    Our {data.label} solutions provide comprehensive benefits to help your business thrive in today's competitive landscape.
                  </p>
                </div>
              </motion.div>
            ))}
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <div className="h-1 w-16 bg-primary mx-auto mb-4"></div>
              <p className="text-muted-foreground">
                Explore how our {data.label} solutions have helped businesses achieve their goals.
              </p>
            </div>
              ...
              {data.caseStudies.map((caseStudy, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <Link href={`/${language}/projects/${caseStudy.id}`} className="text-primary hover:underline inline-flex items-center">
                      Read Case Study
